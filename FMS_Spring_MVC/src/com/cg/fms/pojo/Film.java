...
public class Film {
	...
	public String toString() {
		return "Film [film_id=" + film_id + ", title=" + title
				...
				+ release_year + ", rental_date=" + rental_date + ", length="
				+ length + ", replacement_cost=" + replacement_cost
				+ ", rating=" + rating + ", last_update=" + last_update
				+ ", delete_update=" + delete_update + ", category_id="
				+ category_id + ", album_id=" + album_id + ", language_id="
				+ language_id + ", album=" + album + ", category=" + category
				+ ", languages=" + languages + ", actors=" + actors + "]";
	}
